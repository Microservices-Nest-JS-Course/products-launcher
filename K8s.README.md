...
# Crear deployment Windows:
```
kubectl create deployment <nombre> --image=<registro/url/imagen> --dry-run=client -o yaml | Out-File -Encoding utf8 deployment.yml
```

# Crear service Windows:
```
kubectl create service clusterip <nombre> --tcp=<8888> --dry-run=client -o yaml | Out-File -Encoding utf8 service.yml 
**kubectl create service nodeport <nombre> --tcp=<3000> --dry-run=client -o yaml | Out-File -Encoding utf8 service.yml**
```
* **clusterip**: solo se puede acceder desde dentro del cluster
* **nodeport**: se puede acceder desde fuera del cluster

# Crear deployment MAC:
```
